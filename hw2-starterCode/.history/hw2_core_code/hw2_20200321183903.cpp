...
const float param_Ls[4] = {0.508273, 0.508273, 0.508273, 1.0};
const float param_alpha = 51.2;
const float param_ka[4] = {1.0, 0.5, 0.31, 1.0};
const float param_kd[4] = {1.0, 0.5, 0.31, 1.0};
const float param_ks[4] = {0.5, 0.5, 0.5, 1.0};
