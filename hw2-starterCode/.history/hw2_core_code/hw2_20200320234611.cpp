...
void displayFunc()
{
  ...
  if (!camera_on_rail) {
    ...
    matrix.SetMatrixMode(OpenGLMatrix::ModelView);
    matrix.LoadIdentity();
    matrix.LookAt(splinePointCoords[0][roller_frame_count].x/* + splineNormals[0][roller_frame_count].x / 20*/, 
                  splinePointCoords[0][roller_frame_count].y/* + splineNormals[0][roller_frame_count].y / 20*/,
                  splinePointCoords[0][roller_frame_count].z/* + splineNormals[0][roller_frame_count].z / 20*/, // eye point
                  splineTangents[0][roller_frame_count].x,
                  splineTangents[0][roller_frame_count].y,
                  splineTangents[0][roller_frame_count].z,          // focus point          
  ...
  // DEBUG print
  cout << "Coord: " << splineTangents[0][roller_frame_count].x << " " << splineTangents[0][roller_frame_count].y << " " << splineNormals[0][roller_frame_count].z << endl;
