...
void loadSkyTexture () {
  ...
  // Populate positions array
  // Top
  groundPositions[0] = glm::vec3(500, 990, 500);
  groundPositions[1] = glm::vec3(500, 990, -500);
  groundPositions[2] = glm::vec3(-500, 990, -500);
  groundPositions[3] = glm::vec3(500, 990, 500);
  groundPositions[4] = glm::vec3(-500, 990, 500);
  groundPositions[5] = glm::vec3(-500, 990, -500);
