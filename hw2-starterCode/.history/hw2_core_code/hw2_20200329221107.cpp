...
void compute_t_rail_idx (glm::vec3* tTrianglePositions, glm::vec3* tColors, glm::vec3* tPositions, int pointCnt, int splineIdx, bool left) {
  int currCnt = 0;
  double mult = left? (-0.5) : 0.5;
  for (int i=0; i<pointCnt-1; ++i) {

    glm::vec3 offset = glm::vec3(splineBinormals[splineIdx][i].x * mult, splineBinormals[splineIdx][i].y * mult, splineBinormals[splineIdx][i].z * mult);
    cout << offset << endl;
    // top
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 0] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 10] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 1] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 10] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 11] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 1] + offset;

    // top left
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 2] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 12] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 0] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 12] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 10] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 0] + offset;
    ...
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 2] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 12] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 14] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 2] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 4] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 14] + offset;

    // left
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 4] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 14] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 16] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 4] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 6] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 16] + offset;

    // bottom top left
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 6] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 8] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 18] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 6] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 16] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 18] + offset + offset;

    // bottom
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 8] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 9] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 19] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 8] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 18] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 19] + offset;

    // bottom top right
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 7] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 9] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 19] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 7] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 17] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 19] + offset;

    // right
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 5] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 7] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 17] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 5] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 15] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 17] + offset;

    // top bottom right
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 5] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 3] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 13] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 5] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 15] + offset;
    tTrianglePositions[currCnt++] = tPositions[i * 10 + 13] + offset;
