...
void add_cross_bar_points (glm::vec3* crossBarPositions, int splineIdx, int pointCnt) {
  ...
  for (int i=crossbar_dist / 2 + crossbar_width; i<pointCnt; i+=crossbar_dist) {
    ...
    v_4 = p_0_1 + (b_0_1 * bar_l - n_0_0 * bar_h) * param_rail_scale;
    v_5 = p_0_1 + (n_0_0 * bar_h + b_0_1 * bar_l) * param_rail_scale;
    v_6 = p_0_1 + (n_0_0 * bar_h - b_0_1 * bar_l) * param_rail_scale;
    v_7 = p_0_1 + (Point(0,0,0) - n_0_0 * bar_h - b_0_1 * bar_l) * param_rail_scale;
