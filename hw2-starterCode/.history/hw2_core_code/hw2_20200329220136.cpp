...
void initScene(int argc, char *argv[])
{
  ...
  */
  ...
  splinePointCoords.resize(numSplines * 2); // mult by 2 for two rails
  splineTangents.resize(numSplines * 2);
  splineNormals.resize(numSplines * 2);
  splineBinormals.resize(numSplines * 2);
