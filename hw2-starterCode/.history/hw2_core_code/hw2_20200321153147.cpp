...
void compute_square_rail_idx (glm::vec3* squareTrianglePositions, glm::vec4* squareColors, glm::vec3* squarePositions, int pointCnt) {
  int currCnt = 0;
...
void initScene(int argc, char *argv[])
{
  ...
  */
  ...
  for (int i=0; i<numSplines; ++i) {
    ...
    compute_square_rail_idx(squareTrianglePositions, squareColors, squarePositions, uNumPoints);
