...
void displayFunc()
{
  ...
  if (!camera_on_rail) {
    ...
    matrix.SetMatrixMode(OpenGLMatrix::ModelView);
    matrix.LoadIdentity();
    matrix.LookAt(splinePointCoords[0][roller_frame_count].x + splineNormals[0][roller_frame_count].x / 10, 
                  splinePointCoords[0][roller_frame_count].y + splineNormals[0][roller_frame_count].y / 10,
                  splinePointCoords[0][roller_frame_count].z + splineNormals[0][roller_frame_count].z / 10, // eye point
  ...
  // DEBUG print
  cout << "Coord: " << splineNormals[0][roller_frame_count].z << endl;
