...
void compute_cross_bar_idx (glm::vec3* crossbarTrianglePositions, vector<Point> crossbarPositions) {
  int currCnt = 0;
  for (int i=0; i<crossbar_cnt; i+=2) {
    // right
    crossbarTrianglePositions.push_back(Point(crossbarPositions[i * 4 + 0]));
