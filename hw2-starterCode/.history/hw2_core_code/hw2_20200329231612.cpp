...
void add_cross_bar_points (glm::vec3* squarePositions, int splineIdx, int pointCnt) {
...
void compute_cross_bar_idx (glm::vec3* squareTrianglePositions, glm::vec3* squareColors, glm::vec3* squarePositions, int pointCnt, int splineIdx) {
  int currCnt = 0;
...
void compute_t_rail_idx (glm::vec3* tTrianglePositions, glm::vec3* crossBarTrianglePositions, glm::vec3* tPositions, int pointCnt, int splineIdx, bool left) {
  int currCnt = 0;
  double mult = left? (-0.15) : 0.15;
  // Add a cross bar every cross_bar_mod points
  int cross_bar_mod = 20;
  for (int i=0; i<pointCnt-1; ++i) {
