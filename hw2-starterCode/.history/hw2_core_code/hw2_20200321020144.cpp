...
void add_square_rail_points (glm::vec3* pointPositions, glm::vec3* squarePositions, int splineIdx, int pointCnt, Point& p_0) {
  ...
  for (int i=0; i<pointCnt; ++i) {
    ...
    squarePositions[squarePointCnt+2] = glm::vec3(v_0.x, v_0.y, v_0.z);
    squarePositions[squarePointCnt+3] = glm::vec3(v_0.x, v_0.y, v_0.z);
