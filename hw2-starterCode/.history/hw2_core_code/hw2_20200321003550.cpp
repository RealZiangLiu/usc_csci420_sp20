...
void displayFunc()
{
  ...
  if (!camera_on_rail) {
    ...
    matrix.LookAt(splinePointCoords[0][roller_frame_count].x + 0.01 * splineNormals[0][roller_frame_count].x, 
                  ...
                  splinePointCoords[0][(roller_frame_count+1) % splineVertexCnt[0]].x + 0.01 * splineNormals[0][(roller_frame_count+1) % splineVertexCnt[0]].x, 
                  splinePointCoords[0][(roller_frame_count+1) % splineVertexCnt[0]].y + 0.01 * splineNormals[0][(roller_frame_count+1) % splineVertexCnt[0]].y,
                  splinePointCoords[0][(roller_frame_count+1) % splineVertexCnt[0]].z + 0.01 * splineNormals[0][(roller_frame_count+1) % splineVertexCnt[0]].z,          // focus point          
