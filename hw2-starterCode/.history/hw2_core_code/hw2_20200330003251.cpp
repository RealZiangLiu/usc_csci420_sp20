...
void add_cross_bar_points (vector<Point>& crossbarPositions, int splineIdx, int pointCnt) {
  ...
  for (int i=crossbar_dist / 2 + crossbar_width; i<pointCnt; i+=crossbar_dist) {
    ...
    crossbarPositions.push_back(Point(v_0.x, v_0.y, v_0.z));
    crossbarPositions.push_back(Point(v_1.x, v_1.y, v_1.z));
    crossbarPositions.push_back(Point(v_2.x, v_2.y, v_2.z));
    crossbarPositions.push_back(Point(v_3.x, v_3.y, v_3.z));
    crossbarPositions.push_back(Point(v_4.x, v_4.y, v_4.z));
    crossbarPositions.push_back(Point(v_5.x, v_5.y, v_1.z));
    crossbarPositions.push_back(Point(v_6.x, v_6.y, v_6.z));
    crossbarPositions.push_back(Point(v_7.x, v_7.y, v_7.z));
...
void compute_cross_bar_idx (glm::vec3* crossbarTrianglePositions, const vector<Point>& crossbarPositions) {
  ...
  for (int i=0; i<crossbar_cnt; i+=2) {
    ...
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 4]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 1]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 4]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 5]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 1]);
    // top
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 1]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 5]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 2]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 5]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 6]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 2]);
    // left
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 2]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 6]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 3]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 6]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 7]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 3]);
    // bottom
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 3]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 7]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 0]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 7]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 4]);
    crossbarTrianglePositions[currCnt++] = point_to_vec3crossbarPositions[i * 4 + 0]);
