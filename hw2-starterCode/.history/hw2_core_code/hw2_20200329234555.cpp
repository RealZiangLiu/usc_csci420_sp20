...
void add_cross_bar_points (glm::vec3* crossBarPositions, int splineIdx, int pointCnt) {
  ...
  for (int i=crossbar_dist / 2 + crossbar_width; i<pointCnt; i+=crossbar_dist) {
    ...
    v_0 = p_0_0 + (b_0_0 * bar_l - n_0_0) * param_rail_scale;
    v_1 = p_0_0 + (n_0_0 + b_0_0) * param_rail_scale;
    v_2 = p_0_0 + (n_0_0 - b_0_0) * param_rail_scale;
    v_3 = p_0_0 + (Point(0,0,0) - n_0_0 - b_0_0) * param_rail_scale;
