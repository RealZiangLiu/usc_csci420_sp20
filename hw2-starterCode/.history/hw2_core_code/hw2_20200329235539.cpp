...
void add_cross_bar_points (glm::vec3* crossbarPositions, int splineIdx, int pointCnt) {
  ...
  for (int i=crossbar_dist / 2 + crossbar_width; i<pointCnt; i+=crossbar_dist) {
    ...
    crossBarPositions[crossbarPositions++] = glm::vec3(v_0.x, v_0.y, v_0.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_1.x, v_1.y, v_1.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_2.x, v_2.y, v_2.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_3.x, v_3.y, v_3.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_4.x, v_4.y, v_4.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_5.x, v_5.y, v_1.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_6.x, v_6.y, v_6.z);
    crossBarPositions[crossbarPositions++] = glm::vec3(v_7.x, v_7.y, v_7.z);
...
void initScene(int argc, char *argv[])
{
  ...
  */
  ...
  for (int i=0; i<numSplines; ++i) {
    ...
    compute_cross_bar_idx(crossBar)
