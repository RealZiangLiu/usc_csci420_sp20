...
void compute_square_rail_idx (glm::vec3* squareTrianglePositions, glm::vec3* squarePositions, int pointCnt) {
  ...
  for (int i=0; i<pointCnt-1; ++i) {
    ...
    squareTrianglePositions[currCnt++] = i * 4 + 4;
    squareTrianglePositions[currCnt++] = i * 4 + 1;
    squareTrianglePositions[currCnt++] = i * 4 + 4;
    squareTrianglePositions[currCnt++] = i * 4 + 5;
    squareTrianglePositions[currCnt++] = i * 4 + 1;
    // top
    squareTrianglePositions[currCnt++] = i * 4 + 1;
    squareTrianglePositions[currCnt++] = i * 4 + 5;
    squareTrianglePositions[currCnt++] = i * 4 + 2;
    squareTrianglePositions[currCnt++] = i * 4 + 5;
    squareTrianglePositions[currCnt++] = i * 4 + 6;
    squareTrianglePositions[currCnt++] = i * 4 + 2;
    // left * 4
    squareTrianglePositions[currCnt++] = i * 4 + 2;
    squareTrianglePositions[currCnt++] = i * 4 + 6;
    squareTrianglePositions[currCnt++] = i * 4 + 3;
    squareTrianglePositions[currCnt++] = i * 4 + 6;
    squareTrianglePositions[currCnt++] = i * 4 + 7;
    squareTrianglePositions[currCnt++] = i * 4 + 3;
    // bottom * 4
    squareTrianglePositions[currCnt++] = i * 4 + 3;
    squareTrianglePositions[currCnt++] = i * 4 + 7;
    squareTrianglePositions[currCnt++] = i * 4 + 0;
    squareTrianglePositions[currCnt++] = i * 4 + 7;
    squareTrianglePositions[currCnt++] = i * 4 + 4;
    squareTrianglePositions[currCnt++] = i * 4 + 0;
...
void initScene(int argc, char *argv[])
{
  ...
  */
  ...
  for (int i=0; i<numSplines; ++i) {
    ...
    compute_square_rail_idx(squareTrianglePositions, squarePositions, uNumPoints);
