...
void displayFunc()
{
  ...
  if (!camera_on_rail) {
    ...
    matrix.LookAt(splinePointCoords[0][roller_frame_count].x + 0.16 * splineNormals[0][roller_frame_count].x, 
                  ...
                  splinePointCoords[0][focusIdx].x + 0.15 * splineNormals[0][focusIdx].x, 
                  splinePointCoords[0][focusIdx].y + 0.15 * splineNormals[0][focusIdx].y,
                  splinePointCoords[0][focusIdx].z + 0.15 * splineNormals[0][focusIdx].z,          // focus point          
