...
const double param_rail_scale = 0.02;
...
void displayFunc()
{
  ...
  if (!camera_on_rail) {
    ...
    matrix.LookAt(splinePointCoords[0][roller_frame_count].x + 0.06 * splineNormals[0][roller_frame_count].x, 
                  splinePointCoords[0][roller_frame_count].y + 0.06 * splineNormals[0][roller_frame_count].y,
                  splinePointCoords[0][roller_frame_count].z + 0.06 * splineNormals[0][roller_frame_count].z, // eye point
                  splinePointCoords[0][focusIdx].x + 0.06 * splineNormals[0][focusIdx].x, 
                  splinePointCoords[0][focusIdx].y + 0.06 * splineNormals[0][focusIdx].y,
                  splinePointCoords[0][focusIdx].z + 0.06 * splineNormals[0][focusIdx].z,          // focus point          
