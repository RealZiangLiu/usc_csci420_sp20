...
void loadGroundTexture () {
  ...
  groundPositions[0] = glm::vec3(1000, -10, 1000);
  groundPositions[1] = glm::vec3(1000, -10, -1000);
  groundPositions[2] = glm::vec3(-1000, -10, -1000);
  groundPositions[3] = glm::vec3(1000, -10, 1000);
  groundPositions[4] = glm::vec3(-1000, -10, 1000);
  groundPositions[5] = glm::vec3(-1000, -10, -1000);
...
void loadSkyTexture () {
  ...
  // Populate positions array
  // Top
  groundPositions[0] = glm::vec3(1000, 1000, 1000);
  groundPositions[1] = glm::vec3(1000, 1000, -1000);
  groundPositions[2] = glm::vec3(-1000, 1000, -1000);
  groundPositions[3] = glm::vec3(1000, 1000, 1000);
  groundPositions[4] = glm::vec3(-1000, 1000, 1000);
  groundPositions[5] = glm::vec3(-1000, 1000, -1000);

  // Left
  groundPositions[0] = glm::vec3(-1000, 1000, 500);
  groundPositions[1] = glm::vec3(-1000, 1000, -500);
  groundPositions[2] = glm::vec3(-1000, 1000, -500);
  groundPositions[3] = glm::vec3(-1000, 1000, 500);
  groundPositions[4] = glm::vec3(-1000, 1000, 500);
  groundPositions[5] = glm::vec3(-1000, 1000, -500);
