...
void loadGroundTexture () {
  ...
  groundPositions[0] = glm::vec3(100, -30, 100);
  groundPositions[1] = glm::vec3(100, -30, -100);
  groundPositions[2] = glm::vec3(-100, -30, -100);
  groundPositions[3] = glm::vec3(100, -30, 100);
  groundPositions[4] = glm::vec3(-100, -30, 100);
  groundPositions[5] = glm::vec3(-100, -30, -100);
