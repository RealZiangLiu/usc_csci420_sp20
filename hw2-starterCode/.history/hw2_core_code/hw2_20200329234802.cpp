...
void add_cross_bar_points (glm::vec3* crossBarPositions, int splineIdx, int pointCnt) {
  ...
  for (int i=crossbar_dist / 2 + crossbar_width; i<pointCnt; i+=crossbar_dist) {
    ...
    crossBarPositions[squarePointCnt++] = glm::vec3(v_0.x, v_0.y, v_0.z);
    crossBarPositions[squarePointCnt++] = glm::vec3(v_1.x, v_1.y, v_1.z);
    crossBarPositions[squarePointCnt++] = glm::vec3(v_2.x, v_2.y, v_2.z);
    crossBarPositions[squarePointCnt++] = glm::vec3(v_3.x, v_3.y, v_3.z);
  }
}
