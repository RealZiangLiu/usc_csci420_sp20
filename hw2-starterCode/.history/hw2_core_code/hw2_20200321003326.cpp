...
void displayFunc()
{
  ...
  if (!camera_on_rail) {
    ...
    matrix.SetMatrixMode(OpenGLMatrix::ModelView);
    matrix.LoadIdentity();
    matrix.LookAt(splinePointCoords[0][roller_frame_count].x + 0.03 * splineNormals[0][roller_frame_count].x, 
                  splinePointCoords[0][roller_frame_count].y + 0.03 * splineNormals[0][roller_frame_count].y,
                  splinePointCoords[0][roller_frame_count].z + 0.03 * splineNormals[0][roller_frame_count].z, // eye point
                  splinePointCoords[0][(roller_frame_count+1) % splineVertexCnt[0]].x + 0.03 * splineNormals[0][(roller_frame_count+1) % splineVertexCnt[0]].x, 
                  splinePointCoords[0][(roller_frame_count+1) % splineVertexCnt[0]].y + 0.03 * splineNormals[0][(roller_frame_count+1) % splineVertexCnt[0]].y,
                  splinePointCoords[0][(roller_frame_count+1) % splineVertexCnt[0]].z + 0.03 * splineNormals[0][(roller_frame_count+1) % splineVertexCnt[0]].z,          // focus point          
