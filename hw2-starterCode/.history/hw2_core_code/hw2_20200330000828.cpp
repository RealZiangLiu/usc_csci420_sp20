...
void loadCrossbarTexture (glm::vec3* crossbarPositions) {
  ...
  for (int i=0; i<crossbar_cnt; i+=2) {
    for (int j=0; j<4; ++j) {
      ...
      crossbarTexCoords[1] = glm::vec2(1, 1);
      crossbarTexCoords[2] = glm::vec2(0, 1);
      crossbarTexCoords[3] = glm::vec2(1, 0);
      crossbarTexCoords[4] = glm::vec2(0, 0);
      crossbarTexCoords[5] = glm::vec2(0, 1);
    }
  }
  // ============================= Bind texture VAO and VBO ========================
  // Set positions VBO
