...
const glm::vec4 param_La(0.19225, 0.19225, 0.19225, 1.0);
const glm::vec4 param_Ld(0.50754, 0.50754, 0.50754, 1.0);
const glm::vec4 param_Ls(0.508273, 0.508273, 0.508273, 1.0);
const double param_alpha = 51.2;
const glm::vec4 param_ka(1.0, 0.5, 0.31, 1.0);
const glm::vec4 param_kd(1.0, 0.5, 0.31, 1.0);
const glm::vec4 param_ks(0.5, 0.5, 0.5, 1.0);
