...
// TODO: remove midterm test
const float param_ka[4] = {0.24725, 0.0995, 0.2, 1.0};
const float param_kd[4] = {0.5, 0.5, 0, 1.0};
const float param_ks[4] = {0.3, 0.3, 0.28, 1.0};
const float param_alpha = 23;
